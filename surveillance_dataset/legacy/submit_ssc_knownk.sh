#!/bin/bash
#SBATCH --job-name=surv_ssck
#SBATCH --time=1-00:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --partition=standard
#SBATCH --account=minjilab99
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/surveillance_dataset/logs/cluster_ssck_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/surveillance_dataset/logs/cluster_ssck_%j.err
#
# SSC-TV-L21 + SSC-TV-L21-col only, constrained search, known k.
# Results: split_k5_clean_min30_trials50_knownk_scaled_ssc.csv
#
# Submit from anywhere:
#   sbatch /nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/surveillance_dataset/submit_ssc_knownk.sh
...
python -u "$ROOT/cluster_experiment.py" \
    --sigmas 0.0 --n-trials 50 --known-k --out-tag ssc \
