...
def ssc_admm_nuc_tv(
    ...
    gamma_p  : float            TV weight for row-wise differences  γ_p ||DC||_1
    gamma_q  : float            TV weight for column-wise differences  γ_q ||CD^T||_1
    ...
    for it in range(max_iter):
        ...
        DC  = D @ C
        CDt = C @ D.T
        P = soft_threshold(DC  + Pi_P / sigma, gamma_p / sigma)
