#!/bin/bash
#SBATCH --job-name=cvov_ssc_block_tv_col21_k8_s0p25
#SBATCH --account=minjilab0
#SBATCH --partition=standard
#SBATCH --time=9:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cvov_ssc_block_tv_col21_k8_s0p25_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cvov_ssc_block_tv_col21_k8_s0p25_%j.err
...
echo "========================================"
echo "Job: cvov_ssc_block_tv_col21_k8_s0p25"
echo "Method: SSC-Block-TV-Col21  k: 8  sigma: 0.25  tune_pool_groups: 4"
echo "========================================"
...
python -u cluster_experiment.py \
    ...
    --out-tag cv_overlap_ssc_block_tv_col21_k8_sigma0p25
