#!/bin/bash
#SBATCH --job-name=cv_osc_k5_s0
#SBATCH --account=minjilab0
#SBATCH --partition=standard
#SBATCH --time=1-00:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cv_osc_k5_s0_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cv_osc_k5_s0_%j.err
