#!/bin/bash
#SBATCH --job-name=cvov_tkss_k12_s0p5
#SBATCH --account=minjilab0
#SBATCH --partition=standard
#SBATCH --time=9:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cvov_tkss_k12_s0p5_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cvov_tkss_k12_s0p5_%j.err
...
echo "========================================"
echo "Job: cvov_tkss_k12_s0p5"
echo "Method: TKSS  k: 12  sigma: 0.5  tune_pool_groups: 4"
echo "========================================"
...
python -u cluster_experiment.py \
    ...
    --out-tag cv_overlap_tkss_k12_sigma0p5
