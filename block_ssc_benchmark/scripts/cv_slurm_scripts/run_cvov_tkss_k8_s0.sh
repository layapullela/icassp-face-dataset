#!/bin/bash
#SBATCH --job-name=cvov_tkss_k8_s0
#SBATCH --account=minjilab0
#SBATCH --partition=standard
#SBATCH --time=9:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cvov_tkss_k8_s0_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/block_ssc_benchmark/cv/logs/surveillance/cvov_tkss_k8_s0_%j.err
...
echo "========================================"
echo "Job: cvov_tkss_k8_s0"
echo "Method: TKSS  k: 8  sigma: 0.0  tune_pool_groups: 4"
echo "========================================"
...
python -u cluster_experiment.py \
    ...
    --out-tag cv_overlap_tkss_k8_sigma0
