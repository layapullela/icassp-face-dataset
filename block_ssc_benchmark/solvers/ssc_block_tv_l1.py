"""SSC-Block-TV with element-wise L1 on E: Uses ||E||_1 instead of ||E||_{2,1}^{block}.
...
1. E uses element-wise L1 sparsity (soft-threshold each element independently) 
   instead of block-wise L2,1 (contiguous segment) sparsity.
