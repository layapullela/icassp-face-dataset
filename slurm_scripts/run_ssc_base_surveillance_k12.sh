#!/bin/bash
#SBATCH --job-name=ssc_base_surveillance_k12
#SBATCH --account=minjilab99
#SBATCH --partition=standard
#SBATCH --time=1-00:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/surveillance_dataset/logs/ssc_base_surveillance_k12_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/surveillance_dataset/logs/ssc_base_surveillance_k12_%j.err
...
echo "========================================"
echo "Job: ssc_base_surveillance_k12"
echo "Dataset: surveillance"
echo "K: 12"
echo "known_k: True"
echo "extra_args: --sigmas 0.0"
echo "Methods: OSC TKSS BDOSC"
echo "========================================"
...
python -u cluster_experiment.py \
    ...
    --known-k \
    --sigmas 0.0 \
    --methods OSC TKSS BDOSC \
    --n-trials 10 \
    --out-tag k12_baselines
