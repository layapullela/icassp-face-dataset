#!/bin/bash
#SBATCH --job-name=ballet_het_col
#SBATCH --time=12:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --partition=standard
#SBATCH --account=minjilab99
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/ballet_dataset/logs/ballet_hetero_col_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/ballet_dataset/logs/ballet_hetero_col_%j.err
#
# Append SSC-TV-L21-col onto the existing hetero-noise results.
# Does not retune OSC, SSC-TV-L21, TKSS, or BDOSC.
#
#   sbatch /nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/ballet_dataset/submit_hetero_col.sh
...
python -u "$ROOT/cluster_experiment.py" --k 5 --hetero-noise \
    --n-train-combos 24 --n-test-combos 18 \
