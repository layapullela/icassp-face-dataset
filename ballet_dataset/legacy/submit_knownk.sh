#!/bin/bash
#SBATCH --job-name=ballet_knownk
#SBATCH --time=1-00:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --partition=standard
#SBATCH --account=minjilab99
#SBATCH --output=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/ballet_dataset/logs/ballet_knownk_%j.out
#SBATCH --error=/nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/ballet_dataset/logs/ballet_knownk_%j.err
#
# Same as submit_clean.sh but k is given (true number of sequences).
# Optuna budget scales with n_params: OSC=50, TKSS/SSC-col=75, SSC-TV-L21=100.
# Results: ballet_cluster_knownk_scaled_results.csv
#
# Submit from anywhere:
#   sbatch /nfs/turbo/umms-minjilab/lpullela/icassp_ssc_tv2/ballet_dataset/submit_knownk.sh
